...
<Figure src="/yt-ads-prototyping/add-data-source.png" alt="The 'Add data source' dialog, building a reusable pool of content from a YouTube search: a source name, a search query, the number of results to pull, and a safe-search toggle" />
...
<Figure src="/yt-ads-prototyping/add-action.png" alt="The 'Add an action' dialog, with an on-click trigger and 'Go to screen' selected. The other actions offered are opening a URL, logging an event, showing or hiding an element, and running a script." />
