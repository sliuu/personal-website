...
demoNote: "A prototype of the redesign in React/Vite/TypeScript/CSS. Doesn't connect to any real data or services."
order: 1
---
...
<Figure flat src="/yt-ads-prototyping/flow.webp" alt="A two-column diagram of the division of labor, with arrows running both ways. Researchers and designers start from templates, assemble screens and variants, set element options, and run studies; UX engineers build custom elements, author new templates, grow the shared library, and keep a code hatch for edge cases." />
...
<Figure src="/yt-ads-prototyping/new-user.webp" alt="The page a new user sees who has no projects" />

**Templates make starting from scratch more approachable**, and empower the user to start creating.
<Figure src="/yt-ads-prototyping/new-project.webp" alt="The Start new project page" />
...
<Figure src="/yt-ads-prototyping/prototype-editing.webp" alt="The redesigned editing screen showing distinct sections and clearer interactions" />
...
<Figure src="/yt-ads-prototyping/browse-custom-components.webp" alt="The new custom components view when adding elements to a screen" />
...
<Figure src="/yt-ads-prototyping/components-editor.webp" alt="The component editing page" />


<FigureRow src="/yt-ads-prototyping/data-side-bar.webp" alt="The redesigned data sidebar">
...
<Figure src="/yt-ads-prototyping/add-data-source.webp" alt="The 'Add data source' dialog, building a reusable pool of content from a YouTube search: a source name, a search query, the number of results to pull, and a safe-search toggle" />
...
<Figure src="/yt-ads-prototyping/add-action.webp" alt="The 'Add an action' dialog, with an on-click trigger and 'Go to screen' selected. The other actions offered are opening a URL, logging an event, showing or hiding an element, and running a script." />


## Where it goes next
<Dek>A division of labor, not full self-serve</Dek>

I left Google in October 2025, before the redesign was fully completed. The production features I built along the way are part of the live tool.
