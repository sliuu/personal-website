...
<Figure src="/yt-ads-prototyping/new-user.png" alt="The page a new user sees who has no projects" />
...
<Figure src="/yt-ads-prototyping/browse-custom-components.png" alt="The new custom components view when adding elements to a screen" />
...
<FigureRow src="/yt-ads-prototyping/data-side-bar.png" alt="The redesigned data sidebar">
