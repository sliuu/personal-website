...
<Figure src="/labeling-requests/labeling-request-basics.jpg" alt="Step 1 of 7 in the redesigned wizard, 'First, the basics': naming the request, choosing a production or experimental environment, a description, owners and team, with advanced settings tucked behind a toggle at the bottom" />

**The redesigned quality-control step uses plain-language documentation** for each method.
<Figure src="/labeling-requests/labeling-request-quality-control.jpg" alt="The redesigned quality-control step" />
...
<Figure src="/labeling-requests/label-request-proto.png" alt="Step 4 of the wizard, 'What will labelers answer?': reusing, copying, or writing the question set, with a live preview of the questions as the labeler will see them" />

**A review step provides feedback before saving.**
<Figure src="/labeling-requests/labeling-requests-review.jpg" alt="Review step" />

**The new dashboard for tracking labeling requests**, instead of using the overloaded bug tracker.
<Figure src="/labeling-requests/labeling-requests-dashboard.png" alt="The new dashboard to track labeling requests" />
