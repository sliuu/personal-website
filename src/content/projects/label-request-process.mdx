...
<Figure flat src="/labeling-requests/label-request-flow.png" alt="Flow chart of the existing labeling request process, showing many divergent entry points" />
...
<Figure src="/labeling-requests/labeling-request-basics.jpg" alt="Step 1 of 7 in the redesigned wizard, 'First, the basics': naming the request, choosing a production or experimental environment, a description, owners and team, with advanced settings tucked behind a toggle at the bottom" caption="" />

**The redesigned quality-control step uses plain-language documentation** for each method.
<Figure src="/labeling-requests/labeling-request-quality-control.jpg" alt="The redesigned quality-control step" caption="" />
...
<Figure src="/labeling-requests/label-request-proto.png" alt="Step 4 of the wizard, 'What will labelers answer?': reusing, copying, or writing the question set, with a live preview of the questions as the labeler will see them" caption="" />

**A review step provides feedback before saving.**
<Figure src="/labeling-requests/labeling-requests-review.jpg" alt="Review step" caption="" />

**The new dashboard for tracking labeling requests**, instead of using the overloaded bug tracker.
<Figure src="/labeling-requests/labeling-requests-dashboard.png" alt="The new dashboard to track labeling requests" caption="" />
