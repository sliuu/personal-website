...
<Figure src="/labeling-requests/labeling-request-basics.jpg" alt="Prototype of the redesigned label request wizard" caption="" />
...
**A new section for configuring labeling questions right in the labeling request flow**, and shows a preview of what the labeler will see.
<Figure src="/labeling-requests/label-request-proto.png" alt="Prototype of the redesigned label request wizard" caption="" />
...
**The new dashboard to track labeling requests**, instead of using the overloaded bug tracker.
